                            ...
                            <div class="row">
                                ...
                                <div class="col-4 offset-1">
                                    ...
                                    <div>
                                        <button type="submit"  class="btn btn-danger col-12 mt-3">
                                            <i class="zmdi zmdi-upload"></i>  Change
                                        </button>
                                    </div>
                                </div>
                                <!-- Form Fields -->
                                <div class="row col-6">
                                    <div class="form-group">
                                        ...
                                        <input name="name" disabled type="text" value="{{old('name',$account->name)}}" class="form-control" aria-required="true" aria-invalid="false" placeholder="Enter Your Name">
                                    </div>
                                    @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="email" disabled type="email" class="form-control" value="{{old('email',$account->email)}}" aria-required="true" aria-invalid="false" placeholder="Enter Your Email">
                                    </div>
                                    @error('email')
                                        <div class="text-danger">{{$message}}</div>
                                    @enderror
                                    <div class="form-group">
                                        ...
                                        <textarea name="address" disabled id="" cols="30" rows="10" class="form-control">{{old('address',$account->address)}}</textarea>
                                    </div>
                                    @error('address')
                                        <div class="text-danger">{{$message}}</div>
                                    @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="phone" type="text" disabled class="form-control" value="{{old('phone',$account->phone)}}" aria-required="true" aria-invalid="false" placeholder="Enter Your Phone">
                                    </div>
                                        @error('gender')
                                            <div class="text-danger">{{$message}}</div>
                                        @enderror
                                    ...
                                    <a href="{{route('admin#list')}}" class="btn btn-default">Back</a>
                                </div>
                            </div>
                        </form>
