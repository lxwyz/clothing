                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-5 offset-2 ">
                                <h4 class="my-3"> <i class="bi bi-pencil-square me-2"></i> {{Auth::user()->name}}</h4>
                                <h4 class="my-3"> <i class="bi bi-envelope-open-heart-fill me-2"></i> {{Auth::user()->email}}</h4>
                                <h4 class="my-3"> <i class="bi bi-person-vcard-fill me-2"></i> {{Auth::user()->address}}</h4>
                                <h4 class="my-3"> <i class="bi bi-phone me-2"></i> {{Auth::user()->phone}}</h4>
                                <h4 class="my-3"> <i class="bi bi-gender-ambiguous me-2">{{Auth::user()->gender}}</i></h4>
                                <h4 class="my-3"><i class="bi bi-calendar-date-fill me-2"></i> {{Auth::user()->created_at->format('j-F-y')}}</h4>
                                <br>
                                <a href="{{route('admin#list')}}">
